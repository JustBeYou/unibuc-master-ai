...
args.add_argument('-r', '--results', required=True,
                  help='Directory containing the predictions of the student.')
args.add_argument('-t', '--truth', required=True, help='Directory containing the ground truth.')
args = args.parse_args()

# change this on your machine pointing to your results (txt files)
predictions_path_root = args.results + "/"
# change this on your machine to point to the ground-truth test
gt_path_root = args.truth + "/"
...
for game in range(1, 6):
    for move in range(1, 21):
        ...
        try:
            points_position, points_values, points_score = compare_annotations_regular_tasks(filename_predicted,
                                                                                             filename_gt, verbose)
        except:
            print("For image: ", game_move, " encountered an error")

        print("Image: ", game_move, "Points position: ", points_position, "Points values: ", points_values,
